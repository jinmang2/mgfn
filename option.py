...
def parse_args():
    ...
    parser.add_argument(
        "--hiddensize", type=int, default=512, help="size of feature (default: 512)"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--rgb-list",
        default="data/ucf_tencrop_1d/ucf-i3d.list",
        help="list of rgb features ",
    )
    parser.add_argument(
        "--test-rgb-list",
        default="data/ucf_tencrop_1d/ucf-i3d-test.list",
        help="list of test rgb features ",
    )
    parser.add_argument(
        "--gt", default="data/ucf_tencrop_1d/gt-ucf.npy", help="file of ground truth "
    )

    parser.add_argument("--mag_ratio", type=float, default=0.1, help="mag ratio")

    parser.add_argument(
        "--comment", default="mgfn", help="comment for the ckpt name of the training"
    )
    ...
    parser.add_argument(
        "--pretrained_ckpt", default=None, help="ckpt for pretrained model"
    )
    ...
    parser.add_argument(
        "--preprocessed", action="store_true", help="if train set is already segmented"
    )
    parser.add_argument(
